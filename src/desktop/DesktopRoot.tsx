...
export function DesktopRoot() {
  ...
  const pinBeforeFolderSelection = useCallback(async () => {
    if (view.intent === "pinned") return;
    const pinned = await invoke<DesktopView>("toggle_drawer");
    acceptView(pinned);
  }, [acceptView, view.intent]);
  ...
  return (
    <div className="surface">
      ...
      >
        ...
        <RootsPanel onBeforeSelectRoot={pinBeforeFolderSelection} />
